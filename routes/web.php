...
Route::get('admin/tasks', 'AdminController@tasks')->middleware('auth');
Route::get('admin/tasks/uplaod', 'AdminController@gallery')->middleware('auth');
Route::get('admin/tasks/complete', 'AdminController@gallery')->middleware('auth');
Route::get('admin/tasks/abandon', 'AdminController@gallery')->middleware('auth');
// Gallery 
