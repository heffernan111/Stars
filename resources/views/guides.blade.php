                            ...
                            <thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $guide->tags }}</td>
                                        @if(Auth::check())
                                        <td><a href="guides/download/{{ $guide->id }}" class="btn btn-info" role="button">Download</a></td>
                                        <td><a href="storage/{{ $guide->file_name }}" download="{{ $guide->file_name }}">{{$guide->name}}</a></td>
                                        @else
                                        <td>Login to Download</td>
                                        @endif
                                    </tr>
                                    @endforeach
                                </tbody>
